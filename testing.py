...
def main():
    ...
    # area = 3800
    # hours = 38
    # elec = 261700 #kWH   #206743 kg CO2-e
    # gas = 0
    # diesel = 0
    ...
    scope2_val = df_scope2.at[str(state), int(year)]
    scope3_val = df_scope3.at[str(state), int(year)]
    ...
    scope1_gas = 0.05153
    scope1_diesel = 0.0702

    #emissions = (elec*1.09) + (gas*0.05)
    #emissions = (elec*(1.09)) + (gas*scope1_gas) + (diesel*scope1_diesel)
